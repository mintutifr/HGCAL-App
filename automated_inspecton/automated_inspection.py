...
def check_dir(self):
    ...
    if not os.path.exists(dir_path+ "/data/CSV/Pass0"): os.mkdir(dir_path+ "/data/CSV/Pass0")
    if not os.path.exists(dir_path+ "/data/CSV/Pass1"): os.mkdir(dir_path+ "/data/CSV/Pass1")
#    if not os.path.exists(dir_path+ "/data/CSV/gerber"): os.mkdir(dir_path+ "/data/CSV/gerber")

    if not os.path.exists(dir_path+"/data/MC5"): os.mkdir(dir_path+"/data/MC5")
    if not os.path.exists(dir_path+ "/data/MC5/Pass1"): os.mkdir(dir_path+ "/data/MC5/Pass1")
