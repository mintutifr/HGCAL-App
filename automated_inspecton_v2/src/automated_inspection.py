...
def transfer(self):
    ...
    if errorCSVPass0 != 0:
        ...
        self.label_Finish_Pass.setText("TRANSFER ERROR Pass0 CSV: CHECK THE REMORE SERVER DETAILS")
        self.lineEdit_server.setFocus()
    elif errorCSVPass1 != 0:
        self.label_Finish_Pass.setStyleSheet("color: rgb(255, 28, 70);")  # Red
        self.label_Finish_Pass.setText("TRANSFER ERROR Pass1 CSV : CHECK THE REMORE SERVER DETAILS")
        self.lineEdit_server.setFocus()
    elif errorMC5Pass1 != 0:
        self.label_Finish_Pass.setStyleSheet("color: rgb(255, 28, 70);")  # Red
        self.label_Finish_Pass.setText("TRANSFER ERROR Pass1 MC5: CHECK THE REMORE SERVER DETAILS")
        self.lineEdit_server.setFocus()
    else:
