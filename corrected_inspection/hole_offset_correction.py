...
def offCorrection(fileName_75_pcb, parsed_csv , pathPassCorrectedCSV):
    ...
    fileName_7_pcb[len(fileName_7_pcb)-1] = "" + fileName_7_pcb[len(fileName_7_pcb)-1]
    ...
    CorrectionPass2(parsed_csv, fileName_75_pcb ,pathPassCorrectedCSV)
...
#        fileName_7_measured = dir_path + "/data/CSV/Pass0/hole_measure.csv"
   ...
   # print("z_measured = ", z_measured)
    ...
    propagate_offset_weighted(x_measured,y_measured,z_measured,x_offset,y_offset,fileName_75_pcb, pathPassCorrectedCSV)
...
if __name__ == "__main__":
    ...
    #offset_correction(fileName_75_pcb, fileName_corrected, fileName_corrected_pcb) 
